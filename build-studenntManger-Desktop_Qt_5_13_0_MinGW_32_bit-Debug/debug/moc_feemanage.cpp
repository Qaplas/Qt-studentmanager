...
void feemanage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<feemanage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject feemanage::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_feemanage.data,
    qt_meta_data_feemanage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
